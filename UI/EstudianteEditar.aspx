<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EstudianteEditar.aspx.cs" Inherits="UI.EstudianteEditar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table style="width: 100%;">
            <tr>
                <td class="text-right" style="width: 181px; height: 22px;">Autor ID:</td>
                <td class="modal-sm" style="width: 215px; height: 22px;">
                    <asp:TextBox ID="txtIdEstudiante" runat="server" Width="161px" ReadOnly="true"></asp:TextBox>
                </td>
